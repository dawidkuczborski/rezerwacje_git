...
export default function NotificationAppointmentPage() {
    ...
    // 🟣 ZMIANA TERMINU tylko gdy status=booked
    const isChanged =
    ...
    return (
        <div className="fixed inset-0 w-full h-full bg-white dark:bg-[#1a1a1a] z-[99999] flex flex-col overflow-y-auto">

            {/* HEADER 1:1 JAK MODAL */}
