...
export default function AppointmentModal({ open, onClose, appointmentId, onUpdated }) {
    ...
    return (
        <AnimatePresence>
            ...
            rounded-none md:rounded-2xl overflow-y-auto shadow-2xl flex flex-col"
                    >
                        {/* SUCCESS FLOATING POPUP */}
                        <AnimatePresence>
                            {savedPopup && (
                                <motion.div
                        ...
                        {/* HEADER */}
                        <div className="sticky top-0 bg-gradient-to-r from-orange-500 to-orange-400 text-white
            px-6 py-4 flex justify-between items-center shadow-md z-10">
                        ...
                        {!appointment ? (
                            ...
                            <div className="flex-1 p-6 space-y-6 text-gray-800 dark:text-gray-100">
                                ...
                                <div className="border-b pb-4 dark:border-gray-700">
                                    ...
                                    <div className="mt-1">
                                        <div className="font-semibold">{appointment.client_name?.trim() || "Klient"}</div>
                                        ...
                                        {appointment.client_phone?.trim() ? (
                                            ...
                                            <div className="text-gray-400 dark:text-gray-500 text-sm mt-1">Brak telefonu</div>
                                        )}
                                    </div>
                                </div>
                      ...
                      dark:bg-gray-800 dark:border-gray-700"
                                        ...
                                        <div className="mt-1 flex justify-between">
                                            ...
                                            <span className="text-gray-600 dark:text-gray-300">{appointment.service_price} zł</span>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="border-b pb-4 dark:border-gray-700">
                                    ...
                                    {editMode ? (
                                        ...
                                        <div className="text-gray-400 dark:text-gray-500 mt-1 text-sm">Brak</div>
                                    )}
                                </div>

                                {/* DATA */}
                                <div className="border-b pb-4 dark:border-gray-700">
                                    <label className="text-sm text-gray-500 dark:text-gray-400">Data wizyty</label>
                                    {editMode ? (
                                        <input
                                            type="date"
